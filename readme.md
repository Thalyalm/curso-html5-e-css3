...
- [x] 1.2 – Como a internet funciona?
...
- [x] 7.11 – Desafio: um site com vídeos
...
- [x] 15.4 – Pseudo-elementos em CSS

#### Capítulo 16:

- [x] 16.1 – Modelo de caixas: primeiros passos
- [x] 16.2 – Modelo de caixas na prática (parte 1)
...
- [x] 16.7 – Bordas decoradas
- [x] 16.8 – Desafio do módulo 02

#### Capítulo 17:

- [x] 1.17 – Criando um projeto a partir do zero
- [x] 2.17 – Navegando pelo projeto pronto
- [x] 3.17 – Planejando a estrutura do seu site
...
- [ ] 1.19 - Download das imagens do capítulo
- [ ] 2.19 – Colocando uma imagem de fundo no seu site
- [ ] 3.19 – Imagens que se repetem no fundo do site
- [ ] 4.19 – Configurando a posição da imagem no fundo do site
- [ ] 5.19 – Mudando o tamanho da imagem de fundo do site
- [ ] 6.19 – Background-attachment e shorthand
- [ ] 7.19 – Centralização vertical de caixas
...
- [ ] 4.22 – Navegação no iframe
- [ ] 5.22 – Conteúdo no iframe por código
- [ ] 6.22 – Inconvenientes do iframe
- [ ] 7.22 – Tornando iframes mais seguros
- [ ] 8.22 – Dicas para iframes melhores

#### Capítulo 23:

- [ ] 1.23 – Criando um projeto do zero
- [ ] 2.23 – Vamos começar o projeto
- [ ] 3.23 – Criando a página inicial do projeto
- [ ] 4.23 – Posicionando o conteúdo do site
- [ ] 5.23 – Criando os botões para redes sociais
- [ ] 6.23 – Criando as páginas de cada rede social
- [ ] 7.23 – Personalizando as imagens do projeto
